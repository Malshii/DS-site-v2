...
const Banner = ({ isServicesOpen, isAboutOpen }) => {
  ...
  return (
    <section id="top" className="relative min-h-[90vh] pt-32">
      <WaveBackground />
      ...
      >
        <div className="container relative mx-auto flex flex-col lg:flex-row items-center justify-between px-4 sm:px-6 lg:px-20">
